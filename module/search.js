...
router.get("/show", (req, res, next) => {
    ...
    request("post", "https://music.163.com/weapi/search/suggest/web", data, {ua: "pc", crypto: "weapi"}).then(data => {
...
router.get("/", (req, res, next) => {
    ...
    request("post", "https://music.163.com/weapi/cloudsearch/get/web", data, {ua: "pc", crypto: "weapi"}).then(data=>{
        let result = JSON.parse(data.body.replace(/[\r\n]/g, ""));
        res.send(result);
    });
});
