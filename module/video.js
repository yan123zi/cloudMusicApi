...
//https://music.163.com/weapi/cloudvideo/v1/video/detail?csrf_token=
//获取video详情
router.get("/detail/:id?", (req, res, next) => {
    ...
    if (id) {
        ...
        res.send({
            message:"please input param of video -> 'id'"
        });
    }
});
//获取video的播放链接
...
router.get("/relate/:id?", (req, res, next) => {
    ...
    if (id) {
        request(
            'POST', "https://music.163.com/video?id="+id,{},
            { ua: "pc"}
        ).then(data => {
